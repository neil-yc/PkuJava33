...
public int[] computerDo() {
	//System.out.println("computerDo");
		...
		//while(a>0){
			...
			if(posX+i<=Chessboard.BOARD_SIZE && board[posX+i-1][posY-1].equals("十")){
			X=posX+i;
			Y=posY;
			posX=X;
			posY=Y;
		...
		i=1;
		//while(a>0){
			//System.out.println(board[posX-i][posY].equals("十"));
			if(posX-i>=1 && board[posX-i-1][posY-1].equals("十")){
			X=posX-i;
			Y=posY;
		...
		i=1;
		//while(a>0){
			//System.out.println(board[posX][posY+i].equals("十"));
			if(posY+i<=Chessboard.BOARD_SIZE && board[posX-1][posY+i-1].equals("十")){
			X=posX;
			Y=posY+i;
		...
		//while(a>0){
			//System.out.println(board[posX][posY-i].equals("十"));
			if(posY-i>=1 && board[posX-1][posY-i-1].equals("十")){
			X=posX;
			Y=posY-i;
